...
$data[] = implode('|~~|', array_pad(array($waktu, $ip, $hp, $ua, $user), 5, ''));
$online = count($data);
$fs = fopen($file, 'w');
...
echo "<div align=\"center\"><small>Online: ".$online." | Hôm nay: ".$daily_hits_size." | Tổng: ".$total_hits."</small></div>".$_SERVER['HTTP_USER_AGENT'];
$TimeZone = "+7";
