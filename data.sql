...
--
-- Host: localhost
-- Generation Time: Apr 07, 2014 at 03:29 PM
...
INSERT INTO `lesson_order` (`id`, `user_id`, `fullname`, `office`, `cmnd`, `email`, `sex`, `phone`, `address`, `choosepayment`, `number_account`, `total`, `date`, `status`) VALUES
(1, 2, 'Nguyễn Văn A', '', '122147020', 'member@gmail.com', 'Nam', '123456789', 'Hà Nội', 2, '', 8000000, '2014-04-07 22:00:06', 1),
(2, 2, 'Nguyễn Văn A', '', '122147020', 'member@gmail.com', 'Nam', '123456789', 'Hà Nội', 3, '1234567890123', 5000000, '2014-04-07 22:01:01', 1);

-- --------------------------------------------------------

--
-- Table structure for table `lesson_order_detail`
--
...
CREATE TABLE IF NOT EXISTS `lesson_order_detail` (
  ...
  PRIMARY KEY (`id`),
  KEY `orderid_orderdetail` (`order_id`),
  KEY `proid_orderdetail` (`product_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=3 ;

--
-- Dumping data for table `lesson_order_detail`
--

INSERT INTO `lesson_order_detail` (`id`, `order_id`, `product_id`, `price`, `qty`) VALUES
(1, 1, 21, 4000000, 2),
(2, 2, 20, 5000000, 1);
...
(2, 'member', 'e10adc3949ba59abbe56e057f20f883e', 'member@gmail.com', 'Nguyễn Văn A', 'Nam', '123456789', 'Hà Nội', '2014-04-07 20:28:28');
...
--
-- Constraints for table `lesson_order_detail`
--
